--==================================================================
--> BARAA WAREHOUSE - BRONZE LAYER - TABLE CREATION PROCEDURE
--==================================================================
...
PRINT '    [INFO] Bronze schema created successfully.' ;
END
ELSE
BEGIN
PRINT '    [WARN] Bronze schema already exists - skipping creation.' ;
END ;
GO
...
;
PRINT '    [INFO] Removed existing customer information table.' ;
END ;
...
PRINT '    [INFO] Customer information table created successfully.' ;
GO
...
;
PRINT '    [INFO] Removed existing product information table.' ;
END ;
...
PRINT '    [INFO] Product information table created successfully.' ;
GO
...
PRINT '    [INFO] Removed existing sales details table.' ;
END ;
...
PRINT '    [INFO] Sales details table created successfully.' ;
GO
...
;
PRINT '    [INFO] Removed existing ERP customer demographics table.' ;
END ;
...
PRINT '    [INFO] ERP customer demographics table created successfully.' ;
GO
...
;
PRINT '    [INFO] Removed existing ERP location table.' ;
END ;
...
PRINT '    [INFO] ERP location table created successfully.' ;
GO
...
PRINT '    [INFO] Removed existing ERP product categorization table.' ;
END ;
...
PRINT '    [INFO] ERP product categorization table created successfully.' ;
GO
...
;
PRINT '    [INFO] Removed existing error log table.' ;
END ;
